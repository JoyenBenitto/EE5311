...
let out_042 = v(net1)
let in_042  = v(inp)
meas tran tlh_042 trig v(inp) val=0.9 rise=1 targ v(net1) val=0.9 rise=1
meas tran thl_042 trig v(inp) val=0.9 fall=1 targ v(net1) val=0.9 fall=1
...
let out_084 = v(net1)
let in_084  = v(inp)
meas tran tlh_084 trig v(inp) val=0.9 rise=1 targ v(net1) val=0.9 rise=1
meas tran thl_084 trig v(inp) val=0.9 fall=1 targ v(net1) val=0.9 fall=1
...
let out_126 = v(net1)
let in_126  = v(inp)
meas tran tlh_126 trig v(inp) val=0.9 rise=1 targ v(net1) val=0.9 rise=1
meas tran thl_126 trig v(inp) val=0.9 fall=1 targ v(net1) val=0.9 fall=1
