# Shared "release" target: packages the .sch/.sym/.spice/.cir sources, the
# built report PDF, and a README pointing back to the GitHub repo into
# ROLLNO.zip.
...
release: all
	...
	@cp $(wildcard *.sch) $(wildcard *.sym) $(wildcard *.spice) $(wildcard *.cir) index.pdf .release_stage/$(ROLLNO)/
