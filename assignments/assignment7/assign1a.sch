...
N -250 -180 -240 -180 {lab=c0_b}
N -240 -180 -240 -20 {lab=c0_b}
N -240 -20 -200 -20 {lab=c0_b}
...
N 220 -200 240 -200 {lab=a1}
N 220 -200 220 -60 {lab=a1}
N 220 -60 590 -60 {lab=a1}
N 210 -180 240 -180 {lab=b1}
N 210 -180 210 -40 {lab=b1}
N 210 -40 590 -40 {lab=b1}
N 540 -180 550 -180 {lab=#net1}
N 550 -180 550 -20 {lab=#net1}
N 550 -20 590 -20 {lab=#net1}
N 240 -160 240 0 {lab=c0_b}
N 240 0 590 0 {lab=c0_b}
...
N 80 -450 80 -200 {lab=a1}
N 80 -200 240 -200 {lab=a1}
N 190 -450 190 -180 {lab=b1}
N 190 -180 210 -180 {lab=b1}
...
N 80 -500 80 -450 {lab=a1}
N 190 -600 190 -450 {lab=b1}
N -380 -520 80 -520 {lab=a1}
N 80 -520 80 -500 {lab=a1}
N -380 -620 190 -620 {lab=b1}
N 190 -620 190 -600 {lab=b1}
N -250 -180 160 -180 {lab=c0_b}
N 160 -180 160 -160 {lab=c0_b}
N 160 -160 240 -160 {lab=c0_b}
...
C {lab_wire.sym} -380 -520 0 0 {name=p1 sig_type=std_logic lab=a1}
C {lab_wire.sym} -380 -620 0 0 {name=p2 sig_type=std_logic lab=b1}
...
C {vsource.sym} -1450 -90 0 0 {name=va1 value=0 savecurrent=false}
...
* alter @va3[pulse] = [ 1.8 0 0 0 0 4n 8n]
* alter @va4[pulse] = [ 1.8 0 0 0 0 4n 8n]

tran 1p 20n
meas tran delay_cin_net1 TRIG v(cin) VAL=0.9 RISE=3 TARG v(c0_b) VAL=0.9 FALL=3
meas tran delay_cin_s0 TRIG v(cin) VAL=0.9 RISE=3 TARG v(s0) VAL=0.9 RISE=3
plot v(cin) v(s0)
print delay_cin_net1 delay_cin_s0
.endc
"}
C {sky130_fd_pr/corner.sym} 1210 -280 0 0 {name=CORNER only_toplevel=false corner=tt}
C {vsource.sym} -1260 -160 0 0 {name=va3 value=0 savecurrent=false}
...
C {lab_wire.sym} -80 -180 0 0 {name=p13 sig_type=std_logic lab=c0_b}
